...
<div className="absolute left-8 top-16 grid gap-2 z-10"
...
<div className="font-headings font-bold text-2xl text-accent-green">
...
<button className="bg-primary text-white font-semibold text-sm px-8 py-3 rounded-md">
...
<button className="bg-white border border-border text-foreground font-semibold text-sm px-8 py-3 rounded-md">
